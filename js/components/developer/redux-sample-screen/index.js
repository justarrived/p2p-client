...
class ReduxSampleScreen extends React.Component {
    ...
    static propTypes = {
				...
				increaseAge: React.PropTypes.func,
				decreaseAge: React.PropTypes.func,
        ...
        return (
            <Container>
                <Content>
                    ...
                    {this.props.person.lang.map((lang, i) => <Text key ={i}>{lang}</Text>)}
										<Button onPress={() => this.props.changeName('Anton')}><Text>Change name to Anton</Text></Button>
										<Button onPress={() => this.props.increaseAge()}><Text>Age +1</Text></Button>
										<Button onPress={() => this.props.decreaseAge()}><Text>Age -1</Text></Button>
								</Content>
            </Container>
        );
    }
